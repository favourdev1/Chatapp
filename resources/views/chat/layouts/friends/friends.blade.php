<x-app-layout>
    <div class="overflow-hidden bg-white">
        ...
        <div class="  flex flex-col flex-1 overflow-y-scroll justify-center items-center pt-20">
            ...
            <div
                class=" md:w-3/4 lg:w-2/4 xl:w-2/4   mt-4 shadow-sm flex-1    bg-white  ">

                <div class="px-4 overflow-hidden">
                    <div class=" border-b">
                        <div class="flex justify-start text-gray-600 ">
                            <p id="tab1" class=" py-2 mx-4  border-b-2 border-blue-500">All Users</p>
                            <p id="tab2" class=" py-2 mx-4  "> Groups</p>
                          </div>
                    </div>
